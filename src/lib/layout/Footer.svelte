...
<footer class="max-w-screen-xl mt-auto mx-auto text-brand-white">
	...
	<div class="bg-brand-blueDarker px-4 py-4">
		<p class="text-xs">
			Copyright Folha de S. Paulo. Todos os direitos reservados. É proibida a reprodução do conteúdo
			desta página em qualquer meio de comunicação, eletrônico ou impresso, sem autorização escrita
			da Folhapress (<a class="underline" href="/">pesquisa@folhapress.com.br</a>).
		</p>
	</div>
</footer>
